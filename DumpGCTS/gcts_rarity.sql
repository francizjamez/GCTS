...
CREATE TABLE `rarity` (
  `Rarity` varchar(45) NOT NULL DEFAULT '',
  PRIMARY KEY (`Rarity`)
...
INSERT INTO `rarity` VALUES ('Ancient'),('Arcana'),('Common'),('Immortal'),('Legendary'),('Mythical'),('Rare'),('Uncommon');
...
-- Dump completed on 2019-10-15 13:50:05
