...
CREATE TABLE `item_rarity` (
  ...
  KEY `fk_rarity_idx` (`Rarity`),
  CONSTRAINT `fk_itemName` FOREIGN KEY (`ItemName`) REFERENCES `item` (`ItemName`),
  CONSTRAINT `fk_rarity` FOREIGN KEY (`Rarity`) REFERENCES `rarity` (`Rarity`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `item_rarity` VALUES ('Magus Cypher','Arcana'),('Feast of Abcession','Immortal'),('Glacial Magnolia','Mythical');
...
-- Dump completed on 2019-10-15 13:50:02
